# EXERCÍCIO 14 - FUNCOES
# Quadrado mágico. Um quadrado mágico é aquele dividido em
# linhas e colunas, com um número em cada posição e no qual a
# soma das linhas, colunas e diagonais é a mesma. Por
# exemplo, veja um quadrado mágico de lado 3, com números de
# 1 a 9:
...
# quando completar cada quadrado. Usar um vetor de 1 a 9
# parece ser mais simples que usar uma matriz 3x3.

# Ruby program to generate
