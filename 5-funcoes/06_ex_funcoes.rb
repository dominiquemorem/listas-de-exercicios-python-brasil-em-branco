...
# haver pelo menos duas funções: uma para fazer a conversão e
# uma para a saída. Registre a informação A.M./P.M. como um
# valor ‘A’ para A.M. e ‘P’ para P.M. Assim, a função para
# efetuar as conversões terá um parâmetro formal para
# registrar se é A.M. ou P.M. Inclua um loop que permita que
