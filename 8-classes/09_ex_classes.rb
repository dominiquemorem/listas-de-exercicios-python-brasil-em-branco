...
# o vértice inferior esquerdo do retângulo, que deve ser um
# objeto da classe Ponto.
# - A função para encontrar o centro do retângulo deve
# retornar o valor para um objeto do tipo ponto que indique
# os valores de x e y para o centro do objeto.
# - O valor do centro do objeto deve ser mostrado na tela
# - Crie um menu para alterar os valores do retângulo e
# imprimir o centro deste retângulo.
