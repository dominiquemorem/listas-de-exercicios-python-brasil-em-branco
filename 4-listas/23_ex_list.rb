...
# identificar os usuários com maior espaço ocupado. Através
# de um programa, baixado da Internet, ele conseguiu gerar o
...
# deverá ser feito através de uma função, que será chamada
