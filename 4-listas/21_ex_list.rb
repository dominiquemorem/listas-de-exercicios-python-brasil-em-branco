...
# Carregue uma outra lista com o consumo desses carros, isto
# é, quantos quilômetros cada um desses carros faz com um
...
# gasolina custe R$ 2,25 o litro. Abaixo segue uma tela de
# exemplo. O disposição das informações deve ser o mais
# próxima possível ao exemplo. Os dados são fictícios e podem
